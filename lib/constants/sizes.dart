...
///
class Sizes {
  static double appSreenWidth = screenWidth;
  static double appScreenHeight = screenHeight;

  static bool initialized = false;

  static double getSize(double value) => initialized ? ScreenUtil().setWidth(value) : value;
...
class FontSizes {
  ...
  static double getSp(double value) => initialized ? ScreenUtil().setSp(value) : value;
  ...
  static double get s34 => getSp(34);
